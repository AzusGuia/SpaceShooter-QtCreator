...
void Game::menuView(){
    ...
    music->setMedia(QUrl("qrc:/sounds/intro.mp3"));
    music->play();

    setBackgroundBrush(QBrush(QImage(":/images/AF518.jpg")));
...
void Game::gameStart(){
    ...
    music->stop();
    music->setMedia(QUrl("qrc:/sounds/lv.mp3"));
    music->play();
}
...
void Game::perdeu(){
    ...
    setBackgroundBrush(QBrush(QImage(":/images/gameover.jpg")));

    music->stop();
    music->setMedia(QUrl("qrc:/sounds/go.mp3"));
    music->play();
...
void Game::ganhou()
{
    ...
    setBackgroundBrush(QBrush(QImage(":/images/ganhou.jpg")));
